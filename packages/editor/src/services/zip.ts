 ...
 * enough to inline in the editor rather than pulling in jszip/fflate.
 *
 * Copied from examples/vanilla-js/zip.ts; kept in lockstep via review
 * rather than a shared package. Both editor and demo are independent
 * deployment targets and a shared package is YAGNI today.
 */
